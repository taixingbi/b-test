...
<head>
    ...
    <script src="{{ asset("js/payment/index.js")}}" data-rel-js></script>

    <link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Quicksand" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Source+Code+Pro" rel="stylesheet">

    <link rel="stylesheet" type="text/css" href="{{ asset("css/payment/base.css")}}" data-rel-css="" />

    <!-- CSS for each example: -->
    <link rel="stylesheet" type="text/css" href="{{ asset("css/payment/example1.css")}}" data-rel-css="" />
    ...
    <main>
        ...
        <section class="container-lg">
            ...
            <div class="cell example example1">
                <form method="post" action="{{ route("admin.TestStripe") }}" id="payment-form">
                    <fieldset>
                        <div class="row">
...
<script src="{{ asset("js/payment/l10.js")}}" data-rel-js></script>

<!-- Scripts for each example: -->
<script src="{{ asset("js/payment/example1.js")}}" data-rel-js></script>
