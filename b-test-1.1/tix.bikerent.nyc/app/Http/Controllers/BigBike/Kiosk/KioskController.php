...
//        Log::info("rate: ".$percentage_rate->percentages->percentage_rate);
        ...
        if(Auth::user()->modelHasRole->role_id==3 || Auth::user()->modelHasRole->role_id==6){
            $rate = 1;
        }
//        Log::info("rate: ".$rate);
...
//        dd(Session::get('location'));
        if(Session::get('location')=="203W 58th Street"){
        ...
        }elseif (Session::get('location')=="117W 58th Street" || Session::get('location')=="145 Nassau Street" || Session::get('location')=="40W 55th Street"){
        ...
        }elseif(Session::get('location')=="Central Park West" || Session::get('location')=="Central Park South"
            || Session::get('location')=="Grand Army Plaza" || Session::get('location')=="High Bridge Park"
            || Session::get('location')=="Riverside Park" || Session::get('location')=="East River Park" ){
